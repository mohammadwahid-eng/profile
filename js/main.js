$(function() {
  ...
  var bar = new ProgressBar.Line(lineprog101, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3800,
  ...
  var bar = new ProgressBar.Line(lineprog102, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3900,
  ...
  var bar = new ProgressBar.Line(lineprog103, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3400,
  ...
  var bar = new ProgressBar.Line(lineprog104, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 4000,
